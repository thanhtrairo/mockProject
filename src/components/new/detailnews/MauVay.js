...
const MauVay = () => {
    ...
    return(
        <Row>
            ...
            <p>
                Váy liền thân là một trong những mẫu váy không bao giờ hết hot. Với những ưu điểm nổi bật, mang đến vẻ đẹp thanh lịch, 
           ...
           {/* <h2>Cách 1: Cách phối đồ hack chiều cao cho nữ với các loại quần cạp cao</h2> */}
            ...
            <p>
                Không giống với đồng phục công sở hay quần tây áo vest, váy liền thân có mẫu mã vô cùng đa dạng. Chị em có thể dễ dàng lựa chọn cho 
                mình mẫu váy liền thân phù hợp với dáng người cũng như mức chi phí cần phải bỏ ra. Những mẫu váy liền thân công sở mùa hè luôn mang 
                đến cho các nàng vẻ đẹp nổi bật và không kém phần thanh lịch, sang trọng cần có.<br/>
                Dù bạn bao nhiêu tuổi, phong cách thời trang theo xu hướng nào thì váy liền thân công sở mùa hè vẫn có đầy đủ các xu hướng đó từ nhẹ 
                nhàng, dịu dàng đến mạnh mẽ, cá tính,... Tuy nhiên, với một tuần đi làm tới 6 ngày, bạn cần phối hợp các mẫu váy liền như thế nào để 
                phong cách thời trang của bạn thân không trở nên quá đơn điệu và gây nhàm chán, thiếu nổi bật là một vấn đề được quan tâm rất nhiều.
            </p>
            <p> Xem thêm:<i>Chân Váy Công Sở Màu Đen: Item Không Bao Giờ Lỗi Mốt</i></p>
            ...
            <div className="new-image">
                <p>Váy suông công sở</p> 
                <span className="content-image"> 
                Váy suông có cổ tạo cảm giác thanh lịch cần có chốn công sở và phần đuôi cá phía dưới vừa tạo điểm nhấn cho cả bộ váy vừa đem lại nét dịu dàng, thục nữ cho người mặc.
                </span>
            </div>

            <div className="new-image">
                <p>Váy suông họa tiết</p> 
                <span className="content-image"> 
                    Một chiếc váy suông chất liệu kate nhẹ nhàng, cánh tay được cách điệu tạo cảm giác bồng bềnh, nữ tính. Dây nơ và phần hoa tiết cách điệu 
                    phía trước giúp tạo điểm nhấn ấn tượng, xóa đi nét đơn điệu của chiếc váy.
                </span>
            ...
            <div className="new-image">
                <p>Váy liền thân xòe ống tay dài</p> 
                <span className="content-image"> 
                    Váy màu đen kết hợp cùng ống tay chất liệu voan đi kèm họa tiết chấm bi giúp cho váy không bị thô cứng mà trở nên mềm mại, dịu dàng.
                </span>
            </div>

            <div className="new-image">
                <p>Váy liền thân xòe thêm họa tiết kẻ sọc</p> 
                <span className="content-image"> 
                    Đai váy thắt nơ ở giữa sẽ giúp bạn che đi các khuyết điểm của vòng eo một cách hoàn hảo. Họa tiết kẻ sọc sẽ biến chiếc 
                    váy trở nên bắt mắt và ấn tượng hơn rất nhiều
                </span>
            ...
            <div className="new-image">
                <p>Váy công sở hè trẻ trung, năng động</p> 
                <span className="content-image">              
                    Váy liền thân công sở mùa hè màu trắng luôn mang đến cảm giác nhẹ nhàng, nữ tính cho người mặc. Đừng quên kết hợp cùng một 
                    đôi giày cao gót màu đen vừa giúp tạo điểm nhấn cho set đồ vừa khiến đôi chân của bạn trông dài hơn rất nhiều.
                </span>
            </div>
            ...
            <div className="new-image">
                ...
                <span className="content-image"> 
                    Đai váy thắt nơ ở giữa sẽ giúp bạn che đi các khuyết điểm của vòng eo một cách hoàn hảo. Họa tiết kẻ sọc sẽ biến chiếc 
                    váy trở nên bắt mắt và ấn tượng hơn rất nhiều <br/> <br/>
                    Màu đen luôn là màu đại diện cho quyền lực và sự huyền bí. Một chiếc đầm ôm sát cúp ngực màu đen sẽ mang đến nét sang 
                    trọng và quý phái. Ống tay bằng lưới cách điệu giúp bộ váy trở nên mềm mại, nhẹ nhàng hơn.
                </span>
            ...
            <div className="new-image">
                <p>Đầm công sở sọc giả vest công sở cao cấp</p> 
                <span className="content-image"> 
                    Thiết kế theo phong cách đắp chéo tạo nét độc đáo, thu hút cho người diện. Sử dụng cổ áo màu đen một bên tạo điểm nhấn 
                    ấn tượng, vừa không làm mất đi nét nghiêm túc vừa đầy quyến rũ, mê hoặc. Kẻ sọc trên thân váy sẽ giúp bạn ăn gian chiều 
            ...
            <div className="new-image">
                <p>Váy xòe cổ vuông ấn tượng</p> 
                <span className="content-image"> 
                    Mẫu váy cổ vuông mùa hè với màu cam đất kết hợp với ống tay bồng tạo nét duyên dáng và thanh lịch cho người mặc.
                </span>
                <span><br/><br/>Xem thêm:<i>Bí Kíp Chọn Váy Công Sở Cho Người Béo Bụng "Hack" Vòng 2 Hiệu Quả</i></span>
                
                <p> Đầm công sở cổ vuông mang đến vẻ đẹp sang trọng</p> 
                <span className="content-image"> 
                    Màu đen giúp người mặc hack dáng hoàn hảo. Thiết kế ôm sát và thắt eo ở bụng tạo nét quý phái, quyến rũ nhưng 
            ...
            <div className="new-image">
                <p> Đầm suông dáng chữ A</p> 
                <span className="content-image"> 
                    Vải voan mềm nhẹ kết hợp cùng ống tay áo được cách điệu bánh bèo và thắt nơ trước ngực tạo cho người mặc 
                    thêm nét nữ tính, dịu dàng. Đặc biệt, màu xanh xám giúp tôn da cực kỳ hiệu quả.
                </span>
                <br/>
                <p>  Đầm công sở kẻ sọc đầy thanh lịch</p> 
                <span className="content-image"> 
                    Với thiết kế kẻ sọc kèm đai thắt eo, váy dáng chữ A này vừa giúp người diện trông cao hơn, 
                    vừa khoe trọng vòng eo đầy lôi cuốn.
                </span>
            ...
            <div className="new-image">
                <p>Váy liền họa tiết bó sát người</p> 
                <span className="content-image"> 
                    Thiết kế họa tiết kẻ sọc cùng mắc sắc êm dịu, đầm body cổ chéo hứa hẹn sẽ mang đến cơn sốt thời 
                    trang mùa hè năm nay.
                </span>
            </div>
            ...
            <div className="new-image">
                <p>Váy hoa mang nét đẹp dịu dàng</p> 
                <span className="content-image"> 
                    Không chỉ khiến đôi chân của bạn trong dài hơn, màu xanh biển kết hợp cùng họa tiết hoa của 
                    chiếc váy bánh bèo sẽ biến bạn trở thành một nàng công chúa dịu dàng, xinh đẹp và tươi mát. 
                    Trên đây là 10 mẫu váy liền thân công sở mùa hè mà muốn giới thiệu đến bạn. Hãy lựa chọn cho 
