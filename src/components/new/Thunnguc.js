            ...
            <h3 className='content-text'>
                ...
                <div class="shadow-sm p-3 mb-5 bg-body rounded content-new-detail">
                    ...
                    Nội dung bài viết[Ẩn]
                        ...
                        <li>
                            <a>
                                2. Phối áo nhún ngực đi làm
                            </a>
                        </li>
                        <li>
                            <a>
                                3. Phối áo nhún ngực đi làm
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_vang_3_c2e9ec46661648dda31014842de344c2.jpg"/>
                ...
                <b><i>Phối áo nhún ngực đi làm</i></b>
                <p>
                ...
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_da_1_62fc0ea2f3824103918337e32ef2140f.jpg"/>
                    <p className="content-image"> 
                ...
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_cam_1_5e7a9b56bbd741b3a4cb26a451a753c4.jpg"/>
                    <p className="content-image"> 
                    Phối áo nhún ngực với chân váy mini gọn gàng, xinh xắn cho nàng những ngày đi làm năng động
                    </p>
                </div>
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_xanh_duong_1_f8a81b2b5f384b56b9f46f617dd739b1.jpg"/>
                    <p className="content-image"> 
                ...
                <b><i>Phối áo nhún ngực dạo phố</i></b>
                <p>
                ...
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_vang_1_9208629f08df44e4b27adbbb6838e577.jpg"/>
                    <p className="content-image"> 
                        Diện áo cổ vuông nhún ngực với quần shorts ống rộng cực năng động
                    </p>
                </div>
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_da_1_e56d825a19814ba8a860766660f14731.jpg"/>
                    <p className="content-image"> 
                    Set đồ xuống phố cực ngầu và trẻ trung
                    </p>
                </div>
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_trang_1_0218006913aa4c0c97b58cb07fb0ad6d.jpg"/>
                    <p className="content-image"> 
                    Phối áo với skort hoạ tiết kẻ ô trẻ trung
                    </p>
                </div>
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_den_1_da76c18497d44437ac52f48b16a14dae.jpg"/>
                    <p className="content-image"> 
                    Đừng quên phong cách monochrome cho nàng fashionista lẫn nàng lười nha
                    </p>
                </div>
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_hong_1_1f8e45e71895439fb11f351c6b0b8916.jpg"/>
                    <p className="content-image"> 
                ...
                <b><i>Phối áo nhún ngực đi tiệc, sự kiện</i></b>
                <p>
                ...
                <div className="new-image">
                    <img src="https://product.hstatic.net/1000197303/product/pro_den_1_af4108fabe434b2baab28f3c45e156d5.jpg"/>
                    <p className="content-image"> 
